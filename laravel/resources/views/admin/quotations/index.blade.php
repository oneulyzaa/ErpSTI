...
<div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('admin.quotations.create') }}" class="btn btn-primary d-flex align-items-center gap-2">
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body py-3">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-6 col-sm-auto">
                <a href="{{ route('admin.quotations.index') }}" class="btn btn-outline-secondary btn-sm w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center table-actions">
                        ...
                        <a href="{{ route('admin.quotations.edit', $q) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                        <form action="{{ route('admin.quotations.destroy', $q) }}" method="POST" class="d-inline">
                            @csrf @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Hapus quotation ini?')"><i class="bi bi-trash"></i></button>
                        </form>
                    </td>
                </tr>
                @endforeach

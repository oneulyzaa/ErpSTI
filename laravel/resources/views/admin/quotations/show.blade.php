...
<div class="row g-3 align-items-start">
            ...
            <div class="card-body p-0">
                <div class="row g-0">
                    ...
                    <div class="col-12 col-sm-6 p-4">
                        ...
                        <div class="fw-bold" style="font-size:15px">{{ $quotation->client_company }}</div>
                        <div class="text-muted mt-1" style="font-size:13px;line-height:1.8;">
    ...
    <div class="col-12 col-xl-4">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="summary-row"><span>Total Material</span><span class="summary-val">Rp {{ number_format($quotation->subtotal_material, 0, ',', '.') }}</span></div>
